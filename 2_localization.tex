...
\todo[inline]{remove the following}
...
As the perturbation has a known frequency, its complex amplitude can be extracted from the signal of each \gls{bpm} with a Fourier transform:
